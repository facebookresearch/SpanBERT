...
def add_optimization_args(parser):
    ...
    group.add_argument('--no-sample-size-normalization', action='store_true',
                       help='does not divide the gradient by the sample size')
    ...
    group.add_argument('--weight-decay', '--wd', default=0.0, type=float, metavar='WD',
                       help='weight decay')
    group.add_argument('--initial-accumulator-value', '--iav', default=1.0, type=float, metavar='WD',
                       help='initial accumulator value')
    group.add_argument('--lr-decay', '--lrd', default=1e-5, type=float, metavar='WD',
                       help='learn rate decay')
