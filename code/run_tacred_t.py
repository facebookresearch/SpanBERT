...
from transformers import AdamW, get_linear_schedule_with_warmup, WEIGHTS_NAME, CONFIG_NAME
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fp16_opt_level', type=str, default='O1', help='different pure and mixed precision modes')
